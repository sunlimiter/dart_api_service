...
////Time: 2022/11/23
////Description:
Middleware exceptionHandler(ILogger log) => (Handler handler) => (Request request) => Future.sync(
      () => handler(request),
    ).then((response) => response).catchError((Object error, StackTrace stackTrace) {
      var message = '请求出错了';
      var code = '10000';
